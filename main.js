...
const zod_1 = __webpack_require__("zod");
const nestjs_zod_1 = __webpack_require__("nestjs-zod");
const ejs_1 = tslib_1.__importDefault(__webpack_require__("ejs"));
...
let CustomService = CustomService_1 = class CustomService {
    ...
    generateSite(dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const tplRet = yield this.prisma.siteTemplate.findUniqueOrThrow({
                where: {
                    id: dto.templateId,
                },
            });
            const htmlRet = ejs_1.default.render(tplRet.template, dto.defData);
            return {
                htmlRet,
            };
        });
    ...
    getTemplateDataDef(dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ret = defRet.defData;
            // 转成 json schema
            const jsonSchemaRet = convertToJSONSchema(ret);
            return jsonSchemaRet;
        });
    }
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SiteWithRelationsSchema = exports.SiteSchema = exports.CustomerWithRelationsSchema = exports.CustomerSchema = exports.SiteTemplateDataDefWithRelationsSchema = exports.SiteTemplateDataDefSchema = exports.SiteTemplateWithRelationsSchema = exports.SiteTemplateSchema = exports.AuditsSchema = exports.TransactionIsolationLevelSchema = exports.SortOrderSchema = exports.SiteTemplateScalarFieldEnumSchema = exports.SiteTemplateDataDefScalarFieldEnumSchema = exports.SiteScalarFieldEnumSchema = exports.JsonNullValueInputSchema = exports.JsonNullValueFilterSchema = exports.CustomerScalarFieldEnumSchema = exports.AuditsScalarFieldEnumSchema = exports.InputJsonValue = exports.NullableJsonValue = exports.JsonValue = exports.transformJsonNull = void 0;
const zod_1 = __webpack_require__("zod");
const client_cms_admin_1 = __webpack_require__("@prisma/client-cms_admin");
...
exports.CustomerScalarFieldEnumSchema = zod_1.z.enum(['id', 'createdAt', 'updatedAt', 'isDeleted', 'name']);
...
exports.SiteScalarFieldEnumSchema = zod_1.z.enum(['id', 'createdAt', 'updatedAt', 'isDeleted', 'name', 'siteTemplateId', 'customerId']);
exports.SiteTemplateDataDefScalarFieldEnumSchema = zod_1.z.enum(['id', 'createdAt', 'updatedAt', 'isDeleted', 'name', 'defData', 'siteTemplateId']);
...
exports.SiteTemplateDataDefSchema = zod_1.z.object({
    ...
    updatedAt: zod_1.z.date(),
    isDeleted: zod_1.z.boolean(),
    name: zod_1.z.string().openapi({ "title": "名称" }),
...
}).openapi({ "display_name": "模板数据定义", "display_column": "name" });
