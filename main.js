                    ...
                    return tslib_1.__awaiter(this, void 0, void 0, function* () {
                        if (operation === 'update') {
                            ...
                            if (typeof args.data.name === 'string' && args.where.id != null) {
                                const custom = container.get(cms_admin_services_1.CustomService);
                                custom.syncSiteUpdateToProject({
                                    id: args.where.id,
                                    name: args.data.name,
                                });
                            }
                ...
                $allOperations({ model, operation, args, query }) {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () {
                        if (operation === 'update') {
                            console.log(`[prisma.$extend] ${model}.${operation}(${JSON.stringify(args, null, 2)})`);
                            const custom = container.get(cms_admin_services_1.CustomService);
                            yield custom.syncProjectUpdateToSite({
                                previousSlug: args.where.slug,
                                name: args.data.name,
                            });
                        }
                        return query(args);
...
let TrpcRouter = TrpcRouter_1 = class TrpcRouter {
    constructor(trpc, projectRouter, loggerFactory) {
        this.trpc = trpc;
...
TrpcRouter = TrpcRouter_1 = tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, inversify_1.inject)('Factory<Logger>')),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof trpc_service_1.TrpcService !== "undefined" && trpc_service_1.TrpcService) === "function" ? _a : Object, typeof (_b = typeof project_router_1.ProjectRouter !== "undefined" && project_router_1.ProjectRouter) === "function" ? _b : Object, Function])
], TrpcRouter);
...
const syncSiteUpdateToProjectSchema = zod_1.z.object({
    id: zod_1.z.number(),
    name: zod_1.z.string(),
});
...
class SyncProjectUpdateToSiteSchemaDto extends (0, nestjs_zod_1.createZodDto)(syncProjectUpdateToSiteSchema) {
}
exports.SyncProjectUpdateToSiteSchemaDto = SyncProjectUpdateToSiteSchemaDto;
...
@keyframes blink-animation {
  ...
  100% { background-color: #f9c6d8; }
    ...
    syncSiteUpdateToProject(dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const prevRet = yield this.prisma.site.findUniqueOrThrow({
                where: {
                    id: dto.id,
                },
            });
            if (typeof prevRet.projectId === 'string') {
